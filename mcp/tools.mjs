...
import { FILTER_TYPES } from "../public/js/soundDefaults.js";
...
export const TOOLS = [
  ...
  },
  {
    ...
    description: "The track's filter and its envelope: type (" + FILTER_TYPES.join(", ") + " — lowpass by default), the rest 0..1: cutoff, reson, env (how far the envelope opens the filter per note), attack, decay, sustain, release.",
