...
// ---- the panel ----------------------------------------------------------
// One list, three namespaces -- the same trick the hexop panel uses. Every
// control is `gt` + a short key, and that short key spells its LFO target
// (`gtr_<short>`) and its automation lane (`gtr.<short>`). The list, the
// ranges, the defaults and the famous tones are data in engineData.js (no
// imports, readable from Node); re-exported here so nothing importing them
// from guitar.js changes.
import { GUITAR_DEFAULTS, GUITAR_MOD_KEYS } from "./engineData.js";
export {
  GUITAR_NUM_CTLS, GUITAR_SEL_CTLS, GUITAR_MOD_KEYS, GUITAR_NUM_KEYS, GUITAR_SEL_KEYS,
  GUITAR_MOD_RANGE, GUITAR_MOD_LABELS, GUITAR_DEFAULTS, guitarFromUnit,
  GUITAR_TONE_NAMES, guitarToneDescription, guitarTone,
} from "./engineData.js";
