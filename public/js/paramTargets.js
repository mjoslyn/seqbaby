...
for (const [cls, lfo, auto] of [
  ...
  ["fx-crush-rate",       "crush_rate",       "fx.crush.rate"],
...
export const PARAM_DESCRIPTIONS = {
  ...
  harm:  "the first timbre slider — what it does depends on the engine",
  timb:  "the second timbre slider — what it does depends on the engine",
  morph: "the third timbre slider — what it does depends on the engine",
  decay: "how long a note takes to fall away once struck",
  ...
  fm:    "oscillator FM depth",
  metal: "metalizer: folds the triangle back into harsh upper harmonics",
  noise: "level of the noise source in the oscillator mix",
  "p-filtertype": "the filter's shape or analog-modeled character",
  cutoff: "the track's filter cutoff, after the voice and before the eq",
  reson:  "resonance of that filter: a peak at the cutoff",
  "fx.vinyl":            "how much of the vinyl stage is in the signal",
  "fx.vinyl.warmth":     "how far the vinyl stage rolls the top end off",
  "fx.vinyl.wow":        "depth of the vinyl warble",
  "fx.cassette":         "how much of the cassette stage is in the signal",
  "fx.cassette.flutter": "speed instability of the tape",
  "fx.cassette.sat":     "how hard the tape is driven",
  "fx.fuzz":             "dry/wet for the fuzz stage",
  "fx.fuzz.drive":       "how hard the fuzz is hit",
  "fx.fuzz.tone":        "brightness of the fuzz's output filter",
  "fx.fuzz.level":       "fuzz output level",
  "fx.ringmod":          "dry/wet for the ring modulator",
  "fx.ringmod.freq":     "carrier frequency the signal is multiplied by",
  "fx.shaper":           "dry/wet for the wave shaper",
  "fx.shaper.preamp":    "gain into the shaper",
  "fx.shaper.amt":       "how extreme the shaping curve is",
  "fx.crush":            "dry/wet for the bit crusher",
  "fx.crush.bits":       "bit depth, 16 down to 1",
  "fx.crush.rate":       "the sample rate the crusher runs at",
  ...
  "fx.chorus.rate":      "chorus modulation speed",
  ...
  "fx.flanger.fbk":      "flanger feedback amount",
  ...
  "p-envamt": "how far the envelope moves the filter cutoff on each note",
  ...
  // EQ.
  "p-eq-low":   "low shelf at 250Hz",
  "p-eq-lomid": "peaking bell at 600Hz",
  "p-eq-mid":   "peaking bell at 1.2kHz",
  "p-eq-himid": "peaking bell at 3kHz",
  "p-eq-high":  "high shelf at 5kHz",
  // Compressor.
  "comp-enabled":    "switches the track compressor in",
  "sq-comp__source": "what the compressor listens to",
  "comp-threshold":  "the level above which the compressor starts working",
  "comp-ratio":      "how hard it pulls back what crosses the threshold",
  "comp-attack":     "how quickly it clamps down once the signal crosses the threshold",
  "comp-release":    "how long it takes to let go afterwards",
  "comp-knee":       "how gradually the ratio comes in around the threshold",
  // FX panel controls with no target.
  "sq-track__glide": "portamento: how long a note takes to slide to the next",
  "fx-shaper-mode":  "the curve the wave shaper folds the signal through",
  "fx-delay-sync":   "locks the delay time to the tempo",
  ...
  "sq-wt__scan-dir":    "which way the scan travels through the frames",
  "sq-wt__scan-sync":   "locks the scan to the tempo instead of the speed slider",
  "sq-wt__scan-rate":   "how fast the scan travels, in hz",
  "sq-wt__scan-div":    "scan speed as a division of the tempo, while sync is on",
  "sq-wt__scan-retrig": "restarts the sweep from its start position on every note",
  // Sample editor.
  "sq-samp__snap":      "quantises the region handles to a musical division as you drag them",
  "sq-samp__fit":       "stretches the sample to fit a number of bars at the current tempo",
  "sq-samp__pitchlock": "keeps a bpm-fitted sample at its natural pitch",
  "sq-samp__loop":      "what a step does when it reaches the end of the region",
  "sq-samp__fadein":    "fade at the start of every hit, in seconds",
  "sq-samp__fadeout":   "fade at the end of every hit, in seconds",
  "sq-slice__on-cb":    "plays one slice per step instead of the whole region",
  ...
  "sq-slice__base":     "the midi note the first slice sits on",
  "sq-slice__mode":     "whether a slice stops at the next slice point or plays to the end",
};
