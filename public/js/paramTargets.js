...
export const PARAM_DESCRIPTIONS = {
  ...
  "fx.fuzz.level":       "fuzz output level, to trim back what drive adds",
  ...
  "sq-wt__scan-retrig": "restarts the sweep from its start position on every note. Off leaves one free-running sweep that notes join mid-flight",
  // Sample editor.
