...
const TONES = {
  ...
  "distorted 808": {
    d: "the same 808 driven until the harmonics are louder than the fundamental. The version that still reads as bass on a laptop, where the harmonics are all you hear",
  ...
  "pure sine": {
    d: "no harmonics at all: the reference sub. Inaudible on anything small by design. Use it when something else in the mix already carries the note",
  ...
  "drill slide": {
    d: "808 with the glide on legato, so tied notes slide into each other and separate ones do not. Half the basslines on the radio",
  ...
  "memphis": {
    d: "driven past the point of politeness through a fuzz, tone up, glue hard. A tape-saturated sub that sounds a generation of dubbing old",
  ...
  "house sub": {
    d: "short, tight and gone before the next kick. A clean fundamental with just enough top to be findable, ducking out of the way rather than filling the bar",
