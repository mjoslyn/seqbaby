...
<header class="sq-transport">
    ...
    <!-- The code drawer (codePanel.js): Strudel / Tidal live coding, run into
         the song without stopping the transport. -->
    <button id="code-btn" class="sq-btn--ghost" type="button" aria-pressed="false" title="live code: write Strudel or Tidal patterns, ctrl/⌘ enter runs them into the song"><span class="sq-btn__label">code</span></button>
