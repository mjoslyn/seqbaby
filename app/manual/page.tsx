      ...
      <div className={styles.wrap}>
        ...
        <section className={styles.section} id="motion">
          ...
          <p>
            ...
            either a free speed in hertz or — with <span className={styles.ui}>sync</span>{" "}
            on — a <span className={styles.ui}>length</span>: how long one cycle takes
            in sequencer steps, from half a step up to 64, so it stays in time. Filter
            cutoff is the classic target; effect amounts and the instrument&apos;s own
            tone controls work too.
          </p>
          <p>
            The <span className={styles.ui}>±</span> switch beside the amount says where
            that movement sits. On, the modulation swings either side of where the knob
            is. Off, it only ever lifts the parameter above the knob and lets it fall
            back — the same amount of movement, all of it on one side, which is what you
            want for anything that should idle where you left it and only open up.
          </p>
          <p>
            ...
            euclidean pattern. The length becomes the <em>step</em> length — &ldquo;1
            step&rdquo; means one ring step per sixteenth — and you set the pulses, the
            cycle length and a rotation as you would on the track. <span className={styles.ui}>decay</span>{" "}
            ...
            this shape starts with <span className={styles.ui}>±</span> off, which is
            what that means. Turn it on and rests pull the parameter down as far as
            taps push it up.
